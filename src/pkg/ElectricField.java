...
public class ElectricField {
	...
	public ElectricField() {
		// TODO Auto-generated constructor stub
		this.recalculate(DEFAULT_Z, DEFAULT_TIME, DEFAULT_E0, DEFAULT_WAVE, DEFAULT_BMAG, DEFAULT_NE);
	}
	...
	public double recalculate() {
		// TODO Auto-generated method stub
		this.r = z - 0.03;
		this.omegape = Math.sqrt((Math.pow(ElectricField.Q, 2))*this.ne/(this.EPSILON_0));
		...
		if (r > ElectricField.RS){
			if (this.wave){
				ef = -71.42857142 + this.e0*Math.sin(ElectricField.K*this.z-this.omegauh*time);
			} else {
				ef = -71.42857142 + this.e0;
			}
		} else {
			ef = -5.983571430E5 + 4.786285714E8*(r) - 9.572571429E10*Math.pow(r,2);
		}
